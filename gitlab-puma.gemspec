...
Gem::Specification.new do |s|
  ...
  s.email = ['kamil@gitlab.com', "evan@phx.io"]
  ...
  s.homepage = "https://gitlab.com/gitlab-org/gitlab-puma"
  s.metadata["changelog_uri"] = "https://gitlab.com/gitlab-org/gitlab-puma/blob/gitlab-latency/History.md"
